...
This document describes version 0.02 of File::Append::Undoable (from Perl distribution File-Append-Undoable), released on 2014-05-17.
...
Since transaction requires the function to be idempotent, in the C<check_state>
  phase the function will check if the string has been appended. It will refuse
  to append the same string twice.
...
Source repository is at L<https://github.com/sharyanto/perl-File-Append-Undoable>.
